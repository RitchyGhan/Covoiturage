...
class Co2Controller extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('co2/index.html.twig', array(
            'co2s' => $co2s,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('co2/new.html.twig', array(
            'co2' => $co2,
    ...
    public function showAction(Co2 $co2)
    {
        ...
        return $this->render('co2/show.html.twig', array(
            'co2' => $co2,
    ...
    public function editAction(Request $request, Co2 $co2)
    {
        ...
        return $this->render('co2/edit.html.twig', array(
            'co2' => $co2,
