...
class TypeCovoitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('typecovoit/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('typecovoit/new.html.twig', array(
    ...
    public function showAction(TypeCovoit $typeCovoit)
    {
        ...
        return $this->render('typecovoit/show.html.twig', array(
            'typeCovoit' => $typeCovoit,
    ...
    public function editAction(Request $request, TypeCovoit $typeCovoit)
    {
        ...
        return $this->render('typecovoit/edit.html.twig', array(
            'typeCovoit' => $typeCovoit,
